...
const SECTION_ONE_PARTS = [
  ...
  },
  {
    ...
    lessons: lessonList(
      ...
      ...Array.from({ length:90 }, (_, index) => `Ball 4 activity ${index + 1}`),
      ...Array.from({ length:24 }, (_, index) => `Ball 5 activity ${index + 1}`)
    ),
    balls: [
      ...
      ball("a-part-2-greetings-v6", 4, "Ball 4", "Has, have, this, colours, animals, and possessives", 90),
      ball("a-part-2-greetings-v7", 5, "Ball 5", "Have got and has got animal sentences", 24)
    ]
  },
  {
    id: "part-4",
