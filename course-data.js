...
function ball(id, number, title, summary, lessonCount) {
  return { id, number, title, summary, lessonCount, progressParts: 5 };
}
...
const SECTION_ONE_PARTS = [
  ...
  },
  {
    ...
    href: "game1.html?coursePart=greetings&v=lessonpath76",
    icon: "👋",
    accent: "sky",
    lessons: lessonList(
      "Subject Pronouns",
      ...
      ...Array.from({ length:7 }, (_, index) => `Ball 5 possessives quiz ${index + 1}`),
      "Ball 5 quiz 8: Greeting words",
      ...
      "Ball 5 quiz 18: How",
      "Ball 5 quiz 19: Plural how are you",
      "Ball 5 quiz 20: Type how",
      "Ball 5 quiz 21: Type çawa",
      "Ball 5 quiz 22: Type you",
      "Ball 5 quiz 23: Good morning Susan",
      "Ball 5 quiz 24: Good morning Nina",
      "Ball 5 quiz 25: Goodbye",
      "Ball 5 quiz 26: Ate possessive",
      "Ball 5 quiz 27: Your mother with ate",
      "Ball 5 quiz 28: Ête possessive",
      "Ball 5 quiz 29: Your mother with ête",
      "Ball 5 quiz 30: Type our",
      "Ball 5 quiz 31: Type cats",
