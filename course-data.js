...
const SECTION_ONE_PARTS = [
  ...
  },
  {
    ...
    lessons: lessonList(
      ...
      ...Array.from({ length:32 }, (_, index) => `Ball 5 activity ${index + 1}`),
      ...Array.from({ length:82 }, (_, index) => `Ball 6 activity ${index + 1}`)
    ),
    balls: [
      ...
      ball("a-part-2-greetings-v7", 5, "Ball 5", "Have got and has got animal sentences", 32),
      ball("a-part-2-greetings-v8", 6, "Ball 6", "Mastery practice for has, have, colours, animals, and possessives", 82)
    ]
  },
  {
    id: "part-4",
