...
const SECTION_ONE_PARTS = [
  ...
  },
  {
    ...
    href: "game1.html?coursePart=greetings&v=lessonpath43",
    icon: "👋",
    accent: "sky",
    lessons: lessonList(
      "Subject Pronouns",
      ...
      ...Array.from({ length:71 }, (_, index) => `Ball 4 activity ${index + 1}`)
    ),
    balls: [
      ...
      ball("a-part-2-greetings-v6", 4, "Ball 4", "Has got, possessives, singular and plural forms", 71)
    ]
  },
  {
    id: "part-4",
